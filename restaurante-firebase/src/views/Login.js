...
const Login = ({ users, setActiveUser }) => {
  ...
  const logIn = (e) => {
    ...
    console.log("Valor de email:", email); // Verifica el valor de email
    console.log("Valor de users:", users); // Verifica el valor de users
    
    // Verificar si users contiene la clave email
