...
const MenuCard = ({
  ...
  function updateOrder() {//se encarga de llevar el estado actual de la orden cuando se hace clic en ordenar
        ...
        <div className="-mt-2 p-3 w-64 bg-white border rounded-lg shadow-lg">
          ...
          <div className="mt-1 ml-2 p-1 font-medium text-gray-800">
            <div className="flex items-center">
              ...
              />
              <p className="ml-1">Saludable: {healthScore}</p>
            </div>
            <div className="flex items-center">
              <FontAwesomeIcon
                icon={faLeaf}
              ...
              />
              <p className="ml-1">Vegano: {vegan ? "si" : "No"}</p>
            </div>
            <div className="flex items-center">
              <FontAwesomeIcon
                icon={faThumbsUp}
